...
const Product_PageCard:React.FC<ProductCardProps> = ({item,AddCurrentItem}) => {
  return (
    <>
    <div className='card w-[170px] md:w-[220px] flex flex-col justify-between relative rounded border hover:shadow-2xl shadow-black backdrop-blur-md transition-all duration-300 p-1 text-[--body-color]'>
